...
describe('GiphSearchComponent', () => {
  let fixture: ComponentFixture<GiphSearchComponent>;
  let component: GiphSearchComponent;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GiphSearchComponent);
